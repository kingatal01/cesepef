            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[900px] text-center">
                ...
                <h1 className="mb-5 text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
                  L&apos;expertise au service de l&apos;impact.
                </h1>
                <p className="mb-10 text-lg leading-relaxed text-body-color dark:text-body-color-dark sm:text-xl">
                  Suivi &amp; évaluation, études, formation, conseil —
                  une approche rigoureuse, des résultats mesurables.
                </p>
                <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                  ...
                  <Link
                    href="/contact"
                    className="rounded-xs border border-primary px-8 py-4 text-base font-semibold text-primary duration-300 ease-in-out hover:bg-primary hover:text-white dark:text-white dark:hover:text-white"
                  >
